...
export default function ContractorEcosystemView({ code }: { code: string }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const res = await fetch(`${baseApi}/contractor/ecosystem?code=${encodeURIComponent(code)}`, { credentials: 'include' });
