 ...
 * File: reports.ts
 *
 * Description: reports endpoints for center role
 * Function: Handle center reports operations
 * Importance: reports functionality for center users
 * Connects to: reports.service.ts
 *
 * Notes: Center-specific reports endpoints
 */
...
router.get('/', (0, requireCaps_1.requireCaps)('reports:view'), async (req, res) => {
    try {
        ...
        const data = await reportsService.getReportsData(centerId);
