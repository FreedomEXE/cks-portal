 ...
 * File: services.ts
 *
 * Description: services endpoints for center role
 * Function: Handle center services operations
 * Importance: services functionality for center users
 * Connects to: services.service.ts
 *
 * Notes: Center-specific services endpoints
 */
...
router.get('/', (0, requireCaps_1.requireCaps)('services:view'), async (req, res) => {
    try {
        ...
        const data = await servicesService.getServicesData(centerId);
