 ...
 * File: ecosystem.ts
 *
 * Description: ecosystem endpoints for crew role
 * Function: Handle crew ecosystem operations
 * Importance: ecosystem functionality for crew users
 * Connects to: ecosystem.service.ts
 *
 * Notes: Crew-specific ecosystem endpoints
 */
...
router.get('/', (0, requireCaps_1.requireCaps)('ecosystem:view'), async (req, res) => {
    try {
        ...
        const data = await ecosystemService.getEcosystemData(crewId);
