...
router.use('/dashboard', (0, routes_factory_1.createDashboardRouter)(config_1.AdminConfig.domains.dashboard));
// Catalog routes
router.use('/catalog', (0, routes_factory_2.createCatalogRouter)(config_1.AdminConfig.domains.catalog));
...
router.get('/system/health', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.system.monitoring), async (req, res) => {
    try {
...
router.get('/system/stats', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.system.monitoring), async (req, res) => {
    try {
...
router.post('/system/maintenance', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.system.maintenance), async (req, res) => {
    try {
...
router.get('/activity', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.dashboard.view), async (req, res) => {
    try {
...
router.post('/clear-activity', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.dashboard.admin), async (req, res) => {
    try {
        const adminId = req.user?.userId;
...
router.get('/health', (req, res) => {
    res.json({
        ...
        version: 'v1',
        scope: 'global',
        domains: Object.keys(config_1.AdminConfig.domains),
        features: Object.keys(config_1.AdminConfig.features).filter(key => config_1.AdminConfig.features[key])
    });
});
/**
...
function createProfileRouterPlaceholder() {
    const router = (0, express_1.Router)();
    router.get('/', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.profile.view), (req, res) => {
...
function createDirectoryRouterPlaceholder() {
    const router = (0, express_1.Router)();
    router.get('/', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.directory.view), (req, res) => {
...
function createCreateRouterPlaceholder() {
    const router = (0, express_1.Router)();
    router.get('/', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.users.view), (req, res) => {
...
function createAssignRouterPlaceholder() {
    const router = (0, express_1.Router)();
    router.get('/', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.assignments.view), (req, res) => {
...
function createArchiveRouterPlaceholder() {
    const router = (0, express_1.Router)();
    router.get('/', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.archive.view), (req, res) => {
...
function createSupportRouterPlaceholder() {
    const router = (0, express_1.Router)();
    router.get('/', (0, requireCaps_1.requireCaps)(config_1.AdminConfig.capabilities.support.view), (req, res) => {
