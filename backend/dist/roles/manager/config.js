...
exports.getManagerCapabilities = getManagerCapabilities;
exports.hasCapability = hasCapability;
/**
 * Manager role configuration
 */
exports.ManagerConfig = {
    /**
     * Role metadata
     */
    role: {
 ...
 */
function getManagerCapabilities() {
    const caps = [];
    ...
    extractCaps(exports.ManagerConfig.capabilities);
