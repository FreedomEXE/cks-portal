 ...
 * 
 * Description: Landing page for center users with navigation dashboard
 * Function: Displays welcome message, navigation cards, and news preview
 * Importance: High - Primary navigation interface for center users
 ...
 *        Navigation cards link to various center features.
 */
...
export default function CenterHome() {
  ...
  const name = state.data?.name || state.data?.center_name || 'Center Demo';
  ...
  return (
    <Page title="Center Hub" right={<LogoutButton navigate={navigate} />}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 12, marginTop: 16 }}>
        <NavCard to={`${base}/profile`} title="Profile" subtitle="Center details" />
