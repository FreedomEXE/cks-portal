...
// Keep the same order as the Create page for visual consistency
const manages = [
...
export default function ManagePage() {
  ...
  const role = (params.role as string) || (typeof window !== 'undefined' ? (sessionStorage.getItem('role')||'admin') : 'admin');
  return (
    <Page title="Manage">
