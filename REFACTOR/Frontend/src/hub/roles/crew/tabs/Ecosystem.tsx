 ...
 * Ecosystem.tsx
 * 
 * Description: Crew ecosystem view showing team members and facility structure
 * Function: Display crew's work environment and colleague relationships
 * Importance: Critical - Shows crew member's team structure and work context
 * Connects to: Center API, crew management, team coordination
 * 
 * Notes: Crew-focused ecosystem showing fellow team members and center information.
 */
  ...
  useEffect(() => {
    const loadEcosystem = async () => {
      try {
        ...
        // Mock crew ecosystem data - Crew can see their center and fellow crew members
        const mockEcosystem: EcosystemNode[] = [
          {
            ...
            stats: { crew: 12 },
            children: [
              { id: 'CRW-001', name: 'John Smith (Team Lead) - ME', type: 'crew' },
              ...
              { id: 'CRW-006', name: 'Lisa Brown (Equipment Manager)', type: 'crew' },
              { id: 'CRW-007', name: 'Kevin Martinez (Trainer)', type: 'crew' },
              { id: 'CRW-008', name: 'Robert Wilson (HVAC Lead)', type: 'crew' },
              { id: 'CRW-009', name: 'Amanda Taylor (Electrician)', type: 'crew' },
              { id: 'CRW-010', name: 'Carlos Rivera (Maintenance)', type: 'crew' },
              { id: 'CRW-011', name: 'Jennifer Lee (Systems)', type: 'crew' },
              { id: 'CRW-012', name: 'Tom Clark (Safety Inspector)', type: 'crew' }
            ]
          }
        ];
        ...
        // Auto-expand the center root to show all crew
      ...
      <div>
        ...
        <div className="ui-card" style={{ padding: 32, textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 12, color: '#6b7280', lineHeight: 1.5 }}>
            Your work ecosystem will appear here showing your center<br />
